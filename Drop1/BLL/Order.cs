...
namespace PetShop.BLL
{
    ...
    public class Order {
        ...
        private static readonly PetShop.IBLLStrategy.IOrderStrategy orderInsertStrategy = new OrderWS();
        ...
        private static readonly IOrder dal = null;// PetShop.DALFactory.DataAccess.CreateOrder();
