...
namespace PetShop.BLL {
    ...
    public class Category  : ICategory{
        ...
        public IList<CategoryInfo> GetCategories() {
            var requestURL = ConfigurationManager.AppSettings["ServicesBaseURL"] + "category";
        ...
        public CategoryInfo GetCategory(string categoryId) {
            ...
            var requestURL = ConfigurationManager.AppSettings["ServicesBaseURL"] + "category/" + categoryId;
            var result = Utilities.WebAPICall(requestURL);
