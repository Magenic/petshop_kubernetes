...
namespace ProfileServiceCore.Controllers
{
    public class ProfileController : Controller
    {
        ...
        private const string GET_ACCOUNT_INFO = "SELECT Account.Email, Account.FirstName, Account.LastName, Account.Address1, Account.Address2, Account.City, Account.State, Account.Zip, Account.Country, Account.Phone FROM \"MSPETSHOP4PROFILE\".Account, \"MSPETSHOP4PROFILE\".Profiles " +
            "WHERE Account.UniqueID = Profiles.UniqueID AND Profiles.Username = :Username AND Profiles.ApplicationName = :ApplicationName";
        private const string CREATE_ACCOUNT = "INSERT INTO \"MSPETSHOP4SERVICES\".USERS (USERID, APPLICATIONID, USERNAME, ISANONYMOUS, LASTACTIVITYDATE) VALUES (:UserID, :AppID, :UserName, :IsAnonymous, :LastActivityDate)";
        [HttpPost]
        ...
        private const string GET_CART_ITEMS = "SELECT Cart.ItemId, Cart.Name, Cart.Type, Cart.Price, Cart.CategoryId, Cart.ProductId, Cart.Quantity FROM \"MSPETSHOP4PROFILE\".Profiles INNER JOIN \"MSPETSHOP4PROFILE\".Cart ON Profiles.UniqueID = Cart.UniqueId" +
        ...
        private const string GET_UNIQUEID_FOR_USER = "SELECT UniqueID FROM \"MSPETSHOP4PROFILE\".Profiles WHERE Username = :Username AND ApplicationName = :ApplicationName";
        [HttpPost]
        ...
        private const string CREATE_USER = "INSERT INTO \"MSPETSHOP4PROFILE\".Profiles (UniqueId, Username, ApplicationName, LastActivityDate, LastUpdatedDate, IsAnonymous)" +
        ...
        private const string DELETE_CART = "DELETE FROM \"MSPETSHOP4PROFILE\".Cart WHERE UniqueID = :UniqueID AND IsShoppingCart = :IsShoppingCart";
        private const string INSERT_CART_ITEMS = "INSERT INTO \"MSPETSHOP4PROFILE\".Cart (UniqueID, ItemId, Name, Type, Price, CategoryId, ProductId, " +
        ...
        private const string UPDATE_ACTIVITY_DATES_ACTIVITY_ONLY = "UPDATE \"MSPETSHOP4PROFILE\".Profiles Set LastActivityDate = :LastActivityDate WHERE Username = :Username AND ApplicationName = :ApplicationName";
        private const string UPDATE_ACTIVITY_DATES = "UPDATE \"MSPETSHOP4PROFILE\".Profiles SET LastActivityDate = :LastActivityDate, LastUpdatedDate = :LastUpdatedDate WHERE Username = :Username AND ApplicationName = :ApplicationName";
        [HttpPost]
        ...
        private const string GET_INACTIVE_PROFILES = "SELECT Username FROM \"MSPETSHOP4PROFILE\".Profiles WHERE ApplicationName = :ApplicationName AND LastActivityDate <= :LastActivityDate  AND IsAnonymous = :IsAnonymous";
        [HttpPost]
        ...
        private string SELECT_PROFILE_COUNT = "SELECT COUNT(*) FROM \"MSPETSHOP4PROFILE\".Profiles WHERE ApplicationName = :ApplicationName";
        private string SELECT_PROFILES = "SELECT Username, LastActivityDate, LastUpdatedDate, IsAnonymous FROM \"MSPETSHOP4PROFILE\".Profiles WHERE ApplicationName = :ApplicationName";
        [HttpPost]
        ...
        private const string DELETE_PROFILE = "DELETE FROM \"MSPETSHOP4PROFILE\".Profiles WHERE UniqueID = :UniqueID";
        [HttpPost]
        ...
        private const string DELETE_ACCOUNT = "DELETE FROM \"MSPETSHOP4PROFILE\".Account WHERE UniqueID = :UniqueID";
        private const string INSERT_ACCOUNT = "INSERT INTO \"MSPETSHOP4PROFILE\".Account (UniqueID, Email, FirstName, LastName, Address1, Address2, City, State, Zip, Country, Phone) VALUES (:UniqueID, :Email, :FirstName, :LastName, :Address1, :Address2, :City, :State, :Zip, :Country, :Phone)";
        [HttpPost]
